  ...
  <div class="grid grid-cols-2">
    <div class="details">
      <x-card.card title="Team Details">
        {{-- <x-table.table :tableData="ADD ARRAY HERE" :headers="ADD HEADER ARRAY HERE"/> --}}
        <div class="grid grid-cols-2 grid-rows-4 details">
          ...
          <div class="border text-sm text smallpadding "> CAPACITY</div>
          <div class="border text-sm text smallpadding uppercase text-right "> {!! $team->capacity !!}</div>
          ...
          <div class="border rounded-bl-lg text-sm text smallpadding "> NICKNAME</div>
          <div class="border rounded-br-lg text-sm text smallpadding uppercase text-right "> #</div>
        </div>
      </x-card.card>
        
    </div>
    <div class="details text ml-16">
